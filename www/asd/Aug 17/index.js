Ext.onReady(function() {
    ...
    var carElements = Ext.get('mons').select('div');
    Ext.each(carElements.elements, function(el) {
        var dd = Ext.create('Ext.dd.DD', el, 'monsDDGroup', {
            isTarget  : false
        });
    ...
    var completedDDTarget = Ext.create('Ext.dd.DDTarget', 'mons','monsDDGroup');


    // Instantiate instnaces of DDTarget for the rented and repair drop target elements
    var completedDDTarget = Ext.create('Ext.dd.DDTarget', 'completed', 'monsDDGroup');
